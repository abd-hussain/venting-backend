...
def seed_catalogs(db: Session) -> None:
    ...
    _upsert_by_id(
        ...
        ComfortArea,
        [
            {"id": "relationships", "name_en": "Relationships", "name_ar": "العلاقات", "icon_url": None, "sort_order": 10, "allows_custom_text": False, "audience": "ventor", "topic_group": "relationships", "is_active": True},
            {"id": "marriage", "name_en": "Marriage", "name_ar": "الزواج", "icon_url": None, "sort_order": 20, "allows_custom_text": False, "audience": "ventor", "topic_group": "relationships", "is_active": True},
            {"id": "parenting", "name_en": "Parenting", "name_ar": "الأبوة والأمومة", "icon_url": None, "sort_order": 30, "allows_custom_text": False, "audience": "ventor", "topic_group": "family", "is_active": True},
            {"id": "career_work", "name_en": "Career & work", "name_ar": "العمل والمسار المهني", "icon_url": None, "sort_order": 40, "allows_custom_text": False, "audience": "ventor", "topic_group": "career", "is_active": True},
            {"id": "stress_anxiety", "name_en": "Stress & anxiety", "name_ar": "التوتر والقلق", "icon_url": None, "sort_order": 50, "allows_custom_text": False, "audience": "ventor", "topic_group": "mental", "is_active": True},
            {"id": "loneliness", "name_en": "Loneliness", "name_ar": "الوحدة", "icon_url": None, "sort_order": 60, "allows_custom_text": False, "audience": "ventor", "topic_group": "mental", "is_active": True},
            {"id": "student_life", "name_en": "Student life", "name_ar": "حياة الطالب", "icon_url": None, "sort_order": 70, "allows_custom_text": False, "audience": "ventor", "topic_group": "life", "is_active": True},
            {"id": "financial_stress", "name_en": "Financial stress", "name_ar": "الضغط المالي", "icon_url": None, "sort_order": 80, "allows_custom_text": False, "audience": "ventor", "topic_group": "money", "is_active": True},
            {"id": "health_wellness", "name_en": "Health & wellness", "name_ar": "الصحة والعافية", "icon_url": None, "sort_order": 90, "allows_custom_text": False, "audience": "ventor", "topic_group": "health", "is_active": True},
            {"id": "other", "name_en": "Other", "name_ar": "أخرى", "icon_url": None, "sort_order": 1000, "allows_custom_text": True, "audience": "ventor", "topic_group": None, "is_active": True},
        ],
    )
